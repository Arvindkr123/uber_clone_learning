...
const ConfirmVehicle = ({ setConfirmPanelRide, setVehicleFound }) => {
  return (
    <>
      <h5
        className="p-1 text-center w-[93%] absolute top-0"
        onClick={() => setConfirmPanelRide(false)}
      >
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <button
          ...
          className="w-full sm:w-1/2 mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg"
        >
          Confirm
        </button>
      </div>
